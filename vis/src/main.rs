...
fn enc(data: &String, a: &mut Array2<u8>) -> String {
    /*
    ...
    fn dec(encoded: String, a: &mut Array2<u8>) -> String {
        let mut buf: [u8; 257] = [0; 257];
    /*
    ...
    const INV_S_BOX: [u8;256] = [
        ...
        for i in 1..256{
            inv_P[a[[1 as usize, i as usize]] as usize]=i as usize;
        }
